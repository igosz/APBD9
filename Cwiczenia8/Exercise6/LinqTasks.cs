...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task10()
        {
            ...
            var result = empData.Union(defaultData);
            return result;
        }
        ...
        {
            var result = Emps.WithDirectReports();
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            var result = Depts
                .GroupJoin(
                    ...
                    d => d.Deptno,
                    e => e.Deptno,
                    (d, es) => new { Dept = d, EmployeeCount = es.Count() }
                )
                .Where(de => de.EmployeeCount == 0 || de.EmployeeCount == 5)
                .Select(de => de.Dept)
                .OrderBy(d => d.Dname);
            return result;
        }
